	...
	<div class="main">
		<div class="formMain">
			<div class="regFormElements">
				...
				<form method="post" class="regForm" id="validateIt" action="sellBookParse.php" enctype="multipart/form-data">
					<div class="row">
					...
					<div class="row">
					  <div class="form-group col-md-6">
						<label for="price" class="labelElements">Original Price(Rs.)</label>
					...
					$.ajax({
						...
						success: function(msg) {
							if (msg == 'error') {
								...
								setTimeout(function () {
									location.href="editBookUser.php"; 
								}, 1000);
							}
								...
								$("#errormsg").removeClass("show");
								setTimeout(function () {
									alert("Your transaction ID is: "+msg);
									location.href="transHistory.php"; 
								}, 1000);
							}
						}
					});
