								...
								?>
									...
									?>
                                        <tr>
											...
											<td style="background:#11eeca;font-size:18px;"><a style="color:#fff;" href="editTransactions.php?id=<?php echo $row['id']; ?>">EDIT</a></td>
											<td style="background:red;font-size:18px;"><a style="color:#fff;" href="deleteTransactions.php?id=<?php echo $row['id']; ?>">DEL</a></td>
                                        </tr>
									<?php } ?>
