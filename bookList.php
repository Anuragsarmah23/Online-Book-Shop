								...
								?>
									...
									<?php while($row=mysqli_fetch_assoc($q_run)){ ?>
                                        <tr>
											...
											<td style="background:#11eeca;font-size:18px;"><a style="color:#fff;" href="editBook.php?id=<?php echo $row['id']; ?>">EDIT</a></td>
											<td style="background:red;font-size:18px;"><a style="color:#fff;" href="deleteBook.php?id=<?php echo $row['id']; ?>">DEL</a></td>
                                        </tr>
									<?php } ?>
                                    </tbody>
                                </table>
